...
import { RelatorioMelhorAvaliacaoCategoriaComponent } from './components/relatorio-melhor-avaliacao-categoria/relatorio-melhor-avaliacao-categoria.component';
...
@NgModule({
  declarations: [
    ...
    RelatorioMelhorAvaliacaoCategoriaComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
